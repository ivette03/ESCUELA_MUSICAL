...
<div class="mb-4">
    ...
    <div class="mb-6">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="hora_fin" name="curso[hora_fin]" type="time">
    </div>
    <div class="mb-6">
